...
ALTER TABLE ONLY public."Candidate"
    ADD CONSTRAINT "Candidate_manager_id_fkey" FOREIGN KEY (manager_id) REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ONLY public."Event"
    ADD CONSTRAINT "Event_manager_id_fkey" FOREIGN KEY (manager_id) REFERENCES public."User"(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE ONLY public."Task"
...
ALTER TABLE ONLY public."User"
    ADD CONSTRAINT "User_manager_id_fkey" FOREIGN KEY (manager_id) REFERENCES public."User"(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY public.leave
