...
ALTER TABLE ONLY public."Task"
    ADD CONSTRAINT "Task_Project_id_fkey" FOREIGN KEY ("Project_id") REFERENCES public."Project"(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY public."Task"
...
ALTER TABLE ONLY public."User"
    ADD CONSTRAINT "User_project_id_fkey" FOREIGN KEY (project_id) REFERENCES public."Project"(id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE ONLY public.notification
